...
void ChelloDoc::PixelTwoImageAdd()
{
	// TODO: 여기에 구현 코드 추가.
	int value;
...
void ChelloDoc::LoadImageFile(CArchive& ar)
{
	// TODO: 여기에 구현 코드 추가.
	int i, maxValue;
...
void ChelloDoc::LoadSecondImageFile(CArchive& ar)
{
	// TODO: 여기에 구현 코드 추가.
	int i, maxValue;
	char type[16], buf[256];
...
void ChelloDoc::RegionSharpening()
{
	// TODO: 여기에 구현 코드 추가.
...
void ChelloDoc::Convolve(unsigned char** inputImg, unsigned char** resultImg, int cols, int rows, float mask[][3], int bias, int depth)
{
	// TODO: 여기에 구현 코드 추가.
	int i, j, x, y;
	int red, green, blue;
...
void ChelloDoc::RegionMeaning()
{
	// TODO: 여기에 구현 코드 추가.
	float mask[3][3] = { {1/9.0f,1/9.f,1/9.f}, 
			{1 / 9.0f,1 / 9.f,1 / 9.f}, 
			{1 / 9.0f,1 / 9.f,1 / 9.f} };
